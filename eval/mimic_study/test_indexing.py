...
def make_mimic_source(tmp: Path) -> Path:
    ...
    _write_gz(
        ...
        [
            "subject_id", "hadm_id", "itemid", "charttime", "storetime", "value",
            "valuenum", "valueuom",
        ],
        [
    ...
    _write_gz(
        ...
        [
            [
                101, 1001, 10, 221906, "2020-01-01 09:30:00",
                "2020-01-01 12:00:00", "0.3", "mcg/kg/min", "10", "mL",
            ],
            [
                101, 1001, 10, 221662, "2020-01-01 10:00:00",
                "2020-01-01 12:00:00", "5", "mcg/kg/min", "20", "mL",
            ],
        ],
    )
    _write_gz(
